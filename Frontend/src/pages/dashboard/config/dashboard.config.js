...
export const ROLE_NAVIGATION = {
  ...
  [ROLES.ADMIN]: {
    ...
    navigation: [
      ...
      { id: "ad-logs", label: "Audit Logs", path: "/dashboard/admin/logs", icon: Database },
      ...
      { id: "ad-finance", label: "Finance", path: "/dashboard/admin/finance", icon: DollarSign },
      { id: "ad-subscriptions", label: "Subscriptions", path: "/dashboard/subscriptions", icon: DollarSign },
      { id: "ad-health", label: "System Health", path: "/dashboard/admin/health", icon: Activity },
      { id: "ad-settings", label: "Settings", path: "/dashboard/admin/settings", icon: Settings },
    ]
  }
};
