    ...
    public static class DatabaseIndexesConfiguration
    {
        ...
        private static void ConfigureFreelancerIndexes(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<UserSkill>(entity =>
            {
                ...
                entity.HasIndex(us => us.ProvenYears)
        ...
        private static void ConfigureProposalIndexes(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Proposal>(entity =>
            {
                ...
                entity.HasIndex(p => p.FreelancerUserId)
        ...
        private static void ConfigurePaymentIndexes(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Payment>(entity =>
            {
                ...
                entity.HasIndex(p => p.PaymentProvider)
                ...
                entity.HasIndex(p => new { p.UserId, p.Status, p.CreatedAt })
        ...
        private static void ConfigureReviewIndexes(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Review>(entity =>
            {
                ...
                // فهرس للبحث حسب المشروع
                entity.HasIndex(r => r.ContextEntityId)
                ...
                entity.HasIndex(r => new { r.TargetUserId, r.IsDeleted, r.RatingValue })
            ...
            modelBuilder.Entity<Rating>(entity =>
            {
                ...
                entity.HasIndex(r => r.TotalReviews)
        ...
        private static void ConfigureLogIndexes(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ErrorLog>(entity =>
            {
                ...
                entity.HasIndex(el => el.LoggedAt)
                    .HasDatabaseName("IX_ErrorLog_LoggedAt");
                
                entity.HasIndex(el => new { el.UserId, el.LoggedAt })
        ...
        private static void ConfigureSubscriptionIndexes(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Subscription>(entity =>
            {
                ...
                entity.HasIndex(s => new { s.IsActive, s.EndDate })
        ...
        private static void ConfigureAdditionalIndexes(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Favorite>(entity =>
            {
                ...
                entity.HasIndex(f => new { f.UserId, f.EntityType, f.EntityId })
                    .IsUnique()
            ...
            modelBuilder.Entity<SavedFreelancer>(entity =>
            {
                ...
                entity.HasIndex(sf => sf.FreelancerUserId)
                    .HasDatabaseName("IX_SavedFreelancer_FreelancerUserId");
                
                entity.HasIndex(sf => new { sf.UserId, sf.FreelancerUserId })
                    .IsUnique()
            ...
            {
                entity.HasIndex(bu => bu.BlockedByUserId)
                    .HasDatabaseName("IX_BlockedUser_BlockedByUserId");
                
                entity.HasIndex(bu => bu.BlockedUserId)
                    .HasDatabaseName("IX_BlockedUser_BlockedUserId");
                
                entity.HasIndex(bu => new { bu.BlockedByUserId, bu.BlockedUserId })
                    .IsUnique()
            ...
            {
                entity.HasIndex(r => r.ReportedBy)
